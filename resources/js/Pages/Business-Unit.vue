        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th scope="col">Business Unit Code</th>
            ...
            <tbody>
                ...
                <tr v-for="(business_unit, i) in business_units.data" :key="i">
                    <td scope="row">
                    ...
                    <td class="text-center">
                        <span
                            v-if="business_unit.bu_type == 1"
                            class="badge-primary"
                        >
                            Aqua
                        </span>
                        <span
                            v-if="business_unit.bu_type == 2"
                            class="badge-success"
                        >
                            Agri
                        </span>
                        <span
                            v-if="business_unit.bu_type == 3"
                    ...
                    <td class="flex gap-2">
                        <Link
                            :href="route('bu.edit', business_unit.id)"
