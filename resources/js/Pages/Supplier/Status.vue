...
watch(
    ...
    throttle(function (val) {
        Inertia.get(
            route("customer.status", props.sup_id),
            { search: val.search },
            {
                preserveState: true,
                replace: true,
...
const changeStatus = (id) => {
    Inertia.post(
        route("supplier.apply"),
        {
            bu_id: id,
            sup_code: props.sup_id,
        },
        {
            replace: true,
            preserveScroll: true,
...
<template>
    ...
    <BreezeAuthenticatedLayout>
        ...
        <table>
            ...
            <tbody>
                <tr
                    v-if="!business_units.data.length"
                >
                ...
                <tr
                    v-for="(bu, i) in business_units.data"
                    :key="i"
                >
                    <td
                        scope="row"
