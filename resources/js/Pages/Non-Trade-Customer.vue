...
<template>
    ...
    <BreezeAuthenticatedLayout>
        <div class="flex items-center justify-between">
            <div class="relative">
                ...
                <input
                    ...
                    placeholder="Search for non-trade customer"
                />
            </div>

            <Link
                :href="route('non-trade-customer.create')"
        ...
        <Pagination :links="customers" :search="search" :total="total_record" />
    </BreezeAuthenticatedLayout>
</template>
