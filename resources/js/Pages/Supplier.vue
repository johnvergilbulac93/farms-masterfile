    ...
    <BreezeAuthenticatedLayout>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr v-for="(supplier, i) in suppliers.data" :key="i">
                    <td scope="row">
                        {{ supplier.sup_code }}
                    </td>
                    <td scope="row">
                    ...
                    <td class="flex gap-2">
                        <Link
                            :href="route('supplier.status', supplier.sup_code)"
                            class="font-medium text-indigo-600 hover:underline"
                            >Status</Link
                        >
                        |
                        <Link
                            :href="route('supplier.edit', supplier.sup_code)"
                            class="font-medium text-indigo-600 hover:underline"
                            >Edit</Link
                        >
                    </td>
        ...
        <Pagination :links="suppliers" :search="search" :total="total_record" />
    </BreezeAuthenticatedLayout>
</template>
